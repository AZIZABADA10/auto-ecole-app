<x-app-layout>
    ...
    <div class="mb-6 flex justify-between items-center flex-wrap gap-4">
        ...
        <a href="{{ route('seances.create') }}" class="inline-flex items-center px-4 py-2 bg-emerald-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-emerald-700 transition shadow-sm">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end gap-3">
                                <a href="{{ route('seances.edit', $seance) }}" class="p-1.5 text-slate-400 hover:text-emerald-600 transition bg-slate-50 hover:bg-emerald-50 rounded-lg">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                </a>
                                <form action="{{ route('seances.destroy', $seance) }}" method="POST" onsubmit="return confirm('Supprimer cette séance ?');" class="inline">
                                    @csrf @method('DELETE')
